  ...
  const handleSaveTargetWeight = async () => {
    ...
    try {
      ...
      if (existingGoals) {
        ...
        const { error } = await supabase
          .from("user_goals")
          .update({ target_weight: newTarget })
          .eq("user_id", userId)
        ...
        const { error } = await supabase
          ...
          .insert({
            ...
            target_calories: stats.targetCalories,
            weekly_workout_goal: stats.weeklyWorkoutGoal
          })
            ...
            {editingWeight ? (
              <div className="flex items-center gap-2">
                <Input
                  ...
                  autoFocus
                />
                <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={handleSaveCurrentWeight}>
                  <Check className="w-4 h-4 text-green-500" />
                </Button>
                <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={cancelEditingWeight}>
          ...
          {editingTargetWeight ? (
            <div className="flex items-center gap-2 mt-2">
              ...
              <Input
                ...
                autoFocus
              />
              <Button size="sm" variant="ghost" className="h-6 w-6 p-0" onClick={handleSaveTargetWeight}>
                <Check className="w-3 h-3 text-green-500" />
              </Button>
              <Button size="sm" variant="ghost" className="h-6 w-6 p-0" onClick={cancelEditingTargetWeight}>
