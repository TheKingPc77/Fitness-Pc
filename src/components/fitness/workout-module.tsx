...
const todayWorkout = {
  name: "Treino A - Peito e Tríceps (Hipertrofia)",
  duration: "50 min",
  calories: 420,
  difficulty: "Intermediário",
  focus: "Volume e Intensidade Controlada",
  exercises: [
    {
      id: 1,
...
// Plano Semanal
// Divisão ABCDE com foco em hipertrofia e recuperação otimizada
    ...
    exercises: [
      {
        ...
        tips: [
          "Pegada na largura dos ombros",
          "Desça controlado até o peito (3s)",
          "Explosão na subida (1s)",
          "Escápulas retraídas"
        ],
        technique: "Tempo sob tensão: 3-0-1-0"
      },
      {
        ...
        tips: [
          ...
          "Amplitude completa",
          "Rotação leve no topo",
          "Foco no peitoral superior"
        ],
      ...
      <Card className="p-6 bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600 text-white border-0 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-[1.02]">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-white/80 mb-3">{todayWorkout.focus}</p>
